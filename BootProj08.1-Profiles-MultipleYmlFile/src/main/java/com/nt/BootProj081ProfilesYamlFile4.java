//BootProj081ProfilesYamlFile4.java(20.02.2025)
package com.nt;
...
public class BootProj081ProfilesYamlFile4 {

    public static void main(String[] args) {
        // Get IOC Container
        ApplicationContext ctx = SpringApplication.run(BootProj081ProfilesYamlFile4.class, args);
