//BootProj07ProfilesOracleMysql2.java(19.02.2025)
package com.nt;
...
public class BootProj07ProfilesOracleMysql2 {

	public static void main(String[] args) {
		//Get IOC Container
		ApplicationContext ctx=SpringApplication.run(BootProj07ProfilesOracleMysql2.class, args);
