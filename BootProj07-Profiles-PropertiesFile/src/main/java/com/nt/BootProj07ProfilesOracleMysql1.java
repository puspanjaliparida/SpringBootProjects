//BootProj07ProfilesOracleMysql1.java(19.02.2025)
package com.nt;
...
public class BootProj07ProfilesOracleMysql1 {

	public static void main(String[] args) {
		try(//Get Access To IOC Container
		ConfigurableApplicationContext ctx=SpringApplication.run(BootProj07ProfilesOracleMysql1.class, args);
