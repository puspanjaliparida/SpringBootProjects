//BootProj033MiniProjectDIApplication4.java(13.02.2025)
package com.nt;
...
public class BootProj033MiniProjectDIApplication4 {

    public static void main(String[] args) {
        // Get IOC Container
        ApplicationContext ctx = SpringApplication.run(BootProj033MiniProjectDIApplication4.class, args);
