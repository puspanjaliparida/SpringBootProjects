...
public class TouristOperationsController {
     ...
     @PatchMapping("/pupdate/{tid}/{hikePercentage}")
     public ResponseEntity<?> modifyTouristBudgetDetailsById(@PathVariable("tid") int tid,
    		                                                                                                                @PathVariable("hikePercentage") double hikePercentage){
    	 try {
    		 //Use Service
    		 String resultMsg=service.updateTouristBudgetById(tid, hikePercentage);
     ...
     public ResponseEntity<?> deleteTouristById(@PathVariable("tid") int tid){
    	 try {
    		 //Use Service
    		 String resultMsg=service.removeTouristById(tid);
    		 return new ResponseEntity<String>(resultMsg,HttpStatus.OK);
    	 }
    	 catch(Exception e) {
    		 return new ResponseEntity<String>(e.getMessage(),HttpStatus.INTERNAL_SERVER_ERROR);
