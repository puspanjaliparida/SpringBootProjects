//BootProj032MiniProjectDIApplication2.java(14.02.2025)
package com.nt;
...
public class BootProj034MiniProjectDIApplication2 {

	public static void main(String[] args) {
		//Get IOC Container
		ApplicationContext ctx=SpringApplication.run(BootProj034MiniProjectDIApplication2.class, args);
