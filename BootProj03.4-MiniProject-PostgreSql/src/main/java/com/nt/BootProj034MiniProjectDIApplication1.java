//BootProj034MiniProjectDIApplication1.java(14.02.2025)
package com.nt;
...
public class BootProj034MiniProjectDIApplication1 {

	public static void main(String[] args) {
		try(//Get Access To IOC Container
		ConfigurableApplicationContext ctx=SpringApplication.run(BootProj034MiniProjectDIApplication1.class, args);
		...
		System.out.println("DataSource Name: " + ctx.getBean(DataSource.class).getConnection().getMetaData().getURL());
		...
		//Invoke The Business Method
			...
			//Process The Results
			System.out.println("Employees Belonging To "+degs1 + " " + degs2+ " " + degs3);
			list.forEach(emp->{
